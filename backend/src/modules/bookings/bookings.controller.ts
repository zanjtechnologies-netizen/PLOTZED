...
export class BookingsController {
  ...
  @Get('statistics')
  getStatistics() {
    return this.bookingsService.getBookingStatistics();
  }

  @Get('available-slots/:listingId/:date')
  getAvailableSlots(@Param('listingId') listingId: string, @Param('date') date: string) {
