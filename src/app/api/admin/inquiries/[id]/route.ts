        ...
        emailPromises.push(
          sendEmail({
            ...
            html: `
              ...
              <p>Dear ${existingInquiry.user.name},</p>
              <p>Thank you for your interest in <strong>${existingInquiry.plot.title}</strong>.</p>
        ...
        emailPromises.push(
          sendEmail({
            ...
            html: `
              ...
              <p>Dear ${existingInquiry.user.name},</p>
              <p>We're pleased to inform you that based on your requirements, <strong>${existingInquiry.plot.title}</strong> appears to be an excellent match for you!</p>
              <p>Our property consultant will be reaching out to you soon to schedule a detailed discussion and site visit.</p>
              ${validatedData.admin_notes ? `<p><strong>Note from our team:</strong> ${validatedData.admin_notes}</p>` : ''}
        ...
        emailPromises.push(
          sendEmail({
            ...
            html: `
              ...
              <p>Dear ${existingInquiry.user.name},</p>
              <p>We're thrilled to be part of your journey to owning <strong>${existingInquiry.plot.title}</strong>!</p>
        ...
        emailPromises.push(
          sendEmail({
            ...
            html: `
              ...
              <p>Dear ${existingInquiry.user.name},</p>
              <p>Thank you for your inquiry about <strong>${existingInquiry.plot.title}</strong>.</p>
