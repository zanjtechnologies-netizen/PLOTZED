...
import { ArrowLeft, Share2, X, MapPin, Clock, Anchor, Droplets, Sailboat, Utensils, Palette, Sun, Mountain, Bird, Leaf, TrendingUp, Globe, Building, DollarSign } from 'lucide-react';
                ...
                <div className="absolute bottom-0 left-0 w-full p-8 md:p-16 text-white z-10">
                    <div className="container-custom mx-auto">
                        ...
                        <h1 className={`${playfair.className} text-5xl md:text-7xl font-bold mb-4 max-w-4xl leading-tight`}>
                            Top Regions to Invest in Luxury Real Estate
                        </h1>

                        <div className="flex items-center gap-2 text-[#D8B893] mb-6">
                            <Globe className="w-5 h-5" />
                            <span className="text-lg">Global Markets</span>
                        </div>
                ...
                <div className="container-custom mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className={`${libre.className} text-gray-600 max-w-2xl mx-auto`}>
                            Analysis of high-growth potential regions for the coming decade
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="group relative rounded-2xl overflow-hidden shadow-lg">
                            <div className="h-80 bg-gray-200 relative">
                                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url(/images/property-1.svg)' }} />
                            ...
                            <div className="p-8 bg-white border border-t-0 rounded-b-2xl">
                                ...
                                <p className={`${libre.className} text-gray-600 text-sm leading-relaxed`}>
                                    Premium coastal properties continue to show strong appreciation, driven by limited supply and high demand for lifestyle assets.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="group relative rounded-2xl overflow-hidden shadow-lg">
                            <div className="h-80 bg-gray-200 relative">
                                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url(/images/property-2.svg)' }} />
                                <div className="absolute top-4 right-4 bg-[#D8B893] text-[#112250] px-3 py-1 rounded-full text-sm font-bold flex items-center gap-1">
                            ...
                            <div className="p-8 bg-white border border-t-0 rounded-b-2xl">
                                ...
                                <p className={`${libre.className} text-gray-600 text-sm leading-relaxed`}>
                                    Technology-driven urban centers are attracting global talent and investment, creating robust rental markets and capital growth.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gray-50">
                <div className="container-custom mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className={`${libre.className} text-gray-600 max-w-2xl mx-auto`}>
                            What to look for when evaluating potential luxury property investments
                        </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                        {[
                            { icon: Building, title: 'Infrastructure Development Plans' },
                            { icon: Globe, title: 'Tourism and Connectivity Growth' },
                            { icon: DollarSign, title: 'Rental Yield Potential' },
                            { icon: TrendingUp, title: 'Historical Price Appreciation' },
                            { icon: Building, title: 'Regulatory Environment & Stability' }
                        ].map((item, index) => (
            ...
            <div className="bg-[#112250] py-20 text-center text-white border-t border-white/10">
                <div className="container-custom mx-auto">
                    ...
                    <p className="text-gray-300 mb-10 max-w-xl mx-auto">
                        Explore our curated collection of high-potential investment properties
                    </p>
