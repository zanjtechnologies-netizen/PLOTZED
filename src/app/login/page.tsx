      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@plotzedrealestate.com"
                  required
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 gap-3">
            {/* Google Sign In - Always shown as credentials are configured */}
            <button
              type="button"
            ...
            {/* Facebook Sign In - Hidden until credentials are configured */}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-gray-500">New to Plotzed?</span>
            </div>
          </div>
