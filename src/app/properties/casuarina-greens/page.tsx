...
export default function CasuarinaGreensPage() {
    return (
        <main className={`${playfair.variable} ${libre.variable} ${inter.variable} bg-[#F8F9FA] min-h-screen`}>
            ...
            <section className="relative h-[85vh] min-h-[600px] w-full overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: 'url(/images/casuarina-greens.png)',
                    }}
                >
                        ...
                        <div className="max-w-4xl">
                            ...
                            <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
                                ...
                                <div className="px-6 py-3 bg-white/10 backdrop-blur-md rounded-full text-white border border-white/20 text-sm font-medium tracking-wide">
                                    1.86 Acres | 380 ft Frontage | Legally Verified | Ready for Registration
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-8 space-y-12">
                            ...
                            <div>
                                ...
                                >
                                    <p>
                                        Discover the rare opportunity to own premium land in the heart of Auroville's green belt, surrounded by lush Casuarina trees and unspoiled landscapes.
                                    </p>
                                    <p>
                                        Each land parcel is thoughtfully planned to provide privacy, long-term value, and an environment perfect for building your dream villa, retreat home, or eco-conscious estate. With proximity to Pondicherry city and major connecting highways, this project blends nature, accessibility, and future appreciation in one exclusive location.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="bg-[#112250] rounded-2xl p-8 text-white shadow-xl">
                                    ...
                                    <div className="space-y-6 mb-8">
                                        <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                            ...
                                            <span className="font-semibold text-right">1.86 Acres (81,000 sq ft)</span>
                                        </div>
                                        <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                            <span className="text-gray-300">Frontage</span>
                                            <span className="font-semibold">380 ft</span>
                                        </div>
                                        <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                    ...
                                    <div className="bg-[#1A2C5E] rounded-lg p-4 mb-8 border border-white/10">
                                        ...
                                        <div className="font-medium">Auroville Green Belt Near Rayapudupakkam Lake</div>
                                    </div>
