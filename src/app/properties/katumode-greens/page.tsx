...
export default function KatumodeGreensPage() {
    return (
        <main className={`${playfair.variable} ${libre.variable} ${inter.variable} bg-[#F8F9FA] min-h-screen`}>
            ...
            <section className="relative h-[85vh] min-h-[600px] w-full overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: 'url(/images/katumode-greens.png)',
                    }}
                >
                    ...
                    <div className="container-custom">
                        <div className="max-w-4xl">
                            ...
                            <div className="flex items-center gap-2 text-white/90 mb-8 text-lg">
                                ...
                                <span style={{ fontFamily: 'var(--font-libre)' }}>Auroville Green Belt, Pondicherry</span>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
                                ...
                                <div className="px-6 py-3 bg-white/10 backdrop-blur-md rounded-full text-white border border-white/20 text-sm font-medium tracking-wide">
                                    1.33 Acres | 260 ft Frontage | Legally Verified | Ready for Registration
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-8 space-y-12">
                            ...
                            <div>
                                ...
                                >
                                    <p>
                                        This premium plot is located in one of Auroville's most sought-after and serene green-belt areas, celebrated for its tranquility and closeness to lifestyle hubs.
                                    </p>
                                    <p>
                                        It is perfectly suited for luxury villa development, wellness retreats, eco-hospitality projects, or as a secure long-term investment. Auroville continues to attract global interest for its sustainable living, unique community, and spiritual energy making this a future-proof real estate asset.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="bg-[#112250] rounded-2xl p-8 text-white shadow-xl">
                                    ...
                                    <div className="space-y-6 mb-8">
                                        <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                            ...
                                            <span className="font-semibold text-right">1.33 Acres (58,000 sq ft)</span>
                                        </div>
                                        <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                            <span className="text-gray-300">Frontage</span>
                                            <span className="font-semibold">260 ft</span>
                                        </div>
                                        <div className="flex justify-between items-center border-b border-white/10 pb-4">
                                    ...
                                    <div className="bg-[#1A2C5E] rounded-lg p-4 mb-8 border border-white/10">
                                        ...
                                        <div className="font-medium">Katumode, Auroville Ring Road</div>
                                    </div>
