// ================================================
// src/components/admin/PropertyModalEnhanced.tsx
// Enhanced Modal for creating/editing properties with brochure upload
// ================================================
...
import { X, Upload, Trash2, MapPin, FileText, Search } from 'lucide-react'
...
export default function PropertyModalEnhanced({
  isOpen,
  onClose,
  property,
  onSuccess,
  ...
  const handleRemoveBrochure = () => {
    if (confirm('Are you sure you want to remove the brochure?')) {
      setBrochure('')
    }
  }
      ...
      <div className="bg-white rounded-lg max-w-4xl w-full mx-4 my-8 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-4 border-t border-gray-200 pt-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                PDF format only, max 10MB. This brochure will be available for download on the property page.
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-3 border-t border-gray-200 pt-6">
            ...
            <button
              type="submit"
              disabled={loading || uploadingImages || uploadingBrochure}
